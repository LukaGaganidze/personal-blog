        ...
        <div className={classes["heading__links"]}>
          ...
          <ul>
            ...
            >
              ...
              >
                <li>
                  <Link className={classes["nav-link"]} href="/coding/projects">
                    projects
                  </Link>
                </li>
                <li>
                  <Link className={classes["nav-link"]} href="/coding/articles">
                    articles
                  </Link>
                </li>
              </ul>
            ...
            <li>
              <Link className={classes["nav-link"]} href="/fencing">
                Fencing
              </Link>
            </li>
            <li>
              <Link className={classes["nav-link"]} href="/coffee">
                Coffee
              </Link>
            </li>
            <li>
