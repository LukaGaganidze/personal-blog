    ...
    <div className={classes["container"]}>
      <div className={classes["project-item"]}>
        ...
        <div className={classes["img-box"]}>
          <Link
            className={`${classes["link-1"]} ${classes["image-link"]}`}
          ...
          <Link
            className={`${classes["link-2"]} ${classes["image-link"]}`}
            href={data.projectLink}
            target="_blank"
          >
            <Image
              className={classes["img-2"]}
              src={data.img2}
              alt="ss"
              loading="lazy"
              placeholder="blur"
          ...
          <Link
            className={`${classes["link-3"]} ${classes["image-link"]}`}
            href={data.projectLink}
            target="_blank"
          >
            <Image
              className={classes["img-3"]}
              src={data.img3}
              alt="ss"
              loading="lazy"
              placeholder="blur"
        ...
        <div className={classes["text-box"]}>
          <div className={classes["text-box__content"]}>
            <h3 className={headerFont.className}>{data.header}</h3>
            <p>{data.text1}</p>
            <p>{data.text2}</p>

            <Link
              className={classes["git-link"]}
              href={data.gitLink}
              target="_blank"
            >
              <svg
      ...
      {!data.lastOne && <BotomBorderNonAbsolute />}
    </div>
  );
};
